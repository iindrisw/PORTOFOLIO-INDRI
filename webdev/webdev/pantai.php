...
<!-- PILIH PANTAI -->
<section id="pantai" class="container my-5 pt-5">
  <h2 class="text-center mb-4"><br>PANTAI POPULER</h2>
  ...
  <div class="row">
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai Cemara Indah</h5>
          <p>Nikmati sunset dan pasir putih.</p>
          <a href="cemara.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai Tiris</h5>
          <p>Udara segar dan pemandangan indah.</p>
          <a href="tiris.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai Kejawanan</h5>
          <p>Petualangan alam yang menenangkan.</p>
          <a href="kejawanan.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row mt-4">
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai Karangsong</h5>
          <p>Air jernih dan pemandangan menawan.</p>
          <a href="karang.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai Balongan Indah</h5>
          <p>Suasana tenang dan nyaman.</p>
          <a href="bali.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai 6</h5>
          <p>Pantai eksotis dengan pasir putih bersih.</p>
          <a href="#" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
  </div>
