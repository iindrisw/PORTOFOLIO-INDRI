...
<title>Pantai Indah - Wisata Alam Online</title>
...
<section id="pantai" class="container my-5 pt-5">
  <h2 class="text-center mb-4"><br>GUNUNG POPULER</h2>
  ...
  <div class="row">
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Gunung Ciremai</h5>
          <p>Gunung Ciremai.</p>
          <a href="ciremai.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Bukit SahyangDora</h5>
          <p>Udara segar dan pemandangan indah.</p>
          <a href="sahyangdora.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Gunung Ciwaru</h5>
          <p>Petualangan alam yang menenangkan.</p>
          <a href="ciwaru.php" class="btn btn-pink">Lihat Detail</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row mt-4">
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Bukit Lambosir</h5>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <h5 class="card-title">Pantai 5</h5>
