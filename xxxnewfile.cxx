...
scanf("%i",&bayar);	printf("\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,lafc*jad,bayar-(lafc*jad));break;
...
scanf("%i",&bayar);	printf("~~\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,lab*jad,bayar-(lab*jad));break;
	case 3 : 	    
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n~~\n",bayar,lae*jad,bayar-(lae*jad));};break;
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,bafc*jad,bayar-(bafc*jad));break;
case 2 : 	    
		printf("Kelas : Bisnis\nTarif per-tiket : %i\n",bab);	printf("----------------------------------------\n1) 10.00\n2) 22.00\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,bab*jad,bayar-(bab*jad));break;
		case 3 : 	    
		printf("Kelas           : Ekonomi\n----------------------------------------\nTarif per-tiket : %i\n",bae);	printf("----------------------------------------\n1) 11.30\n2) 23.45\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,bae*jad,bayar-(bae*jad));break;}break;
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,cifc*jad,bayar-(cifc*jad));break;	
	case 2 : 	    
		printf("Kelas : Bisnis ----------------------------------------\nTarif per-tiket : %i\n",cib);	printf("----------------------------------------\n1) 18.20\n2) 10.00\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,cib*jad,bayar-(cib*jad));break;
		case 3 : 	    
		printf("Kelas : Ekonomi\n----------------------------------------\nTarif per-tiket : %i\n",cie);	printf("----------------------------------------\n1) 10.00\n2) 19.45\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,cie*jad,bayar-(cie*jad));break;}
break;
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,aafc*jad,bayar-(aafc*jad));break;
        case 2 : 	    
		printf("Kelas : Bisnis \n----------------------------------------\nTarif per-tiket : %i\n",aab);	printf("----------------------------------------\n1) 18.20\n2) 20.20\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,aab*jad,bayar-(aab*jad));break;
		case 3 : 	    
		printf("Kelas : Ekonomi\n----------------------------------------\nTarif per-tiket : %i\n",aae);	printf("----------------------------------------\n1) 16.45\n2) 23.15\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,aae*jad,bayar-(aae*jad));break;}break;
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,wafc*jad,bayar-(wafc*jad));break;
	case 2 : 	    
		printf("Kelas : Bisnis\nTarif per-tiket : %i\n",wab);	printf("----------------------------------------\n1) 10.15\n2) 17.50\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,wab*jad,bayar-(wab*jad));break;
	case 3 : 	    
		printf("Kelas : Ekonomi\n----------------------------------------\nTarif per-tiket : %i\n",wae);	printf("----------------------------------------\n1) 11.00\n2) 13.45\nPilih jadwal keberangkatan (1/2) : ");
		scanf("%i",&jadwal);
		switch(jadwal)
...
scanf("%i",&bayar);	printf("----------------------------------------\nKembalian : %i - %i = %i\n----------------------------------------\n",bayar,wae*jad,bayar-(wae*jad));break;
