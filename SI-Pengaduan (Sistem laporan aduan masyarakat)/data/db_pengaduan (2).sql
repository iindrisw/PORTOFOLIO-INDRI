...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2026 at 07:39 PM
...
(6, 17, 4, '\"Terima kasih atas laporannya, warga. Kami sangat menghargai kepedulian Anda terhadap keselamatan pengguna jalan. Informasi mengenai lubang jalan di depan gerbang utama UIN Siber Syekh Nurjati telah masuk dalam daftar prioritas perbaikan tim pemeliharaan jalan Dinas PUPR hari ini. Petugas akan segera melakukan penambalan darurat sore ini untuk meminimalkan risiko kecelakaan. Mohon tetap berhati-hati saat melintas, terutama saat cuaca hujan.\"', 1, 0, '2026-04-21 16:23:20'),
(7, 18, 4, 'Halo Ayes. Terima kasih atas laporannya melalui sistem Si-Pengaduan. Laporan Anda mengenai kerusakan atap dan bangku halte di area kampus UIN SSC telah kami terima dan masuk ke dalam tahap Validasi Admin.  Saat ini, tim sarana dan prasarana sedang menjadwalkan pengecekan langsung ke lokasi untuk menilai tingkat kerusakan baut dan kebocoran atap tersebut. Kami akan segera melakukan Update Status jika tindakan perbaikan sudah mulai dilaksanakan.  Sebagai bentuk apresiasi karena telah peduli terhadap fasilitas kampus, poin apresiasi akan segera ditambahkan ke akun Anda setelah status laporan ini dinyatakan \'Selesai\'. Silakan pantau terus perkembangannya melalui fitur Cek Status. Terima kasih atas kontribusinya.', 1, 0, '2026-05-03 15:06:01'),
(8, 19, 4, 'Halo. Terima kasih telah menghubungi layanan Si-Pengaduan untuk permohonan informasi.  \r\nTerkait jadwal pemeliharaan jaringan air di wilayah Kecamatan Sumber, dapat kami sampaikan bahwa proses pembersihan pipa distribusi dijadwalkan setiap hari Selasa minggu kedua setiap bulannya mulai pukul 10.00 hingga 14.00 WIB. Untuk bulan Mei, pemeliharaan akan dilakukan pada tanggal 12 Mei 2026.\r\nKami menyarankan warga untuk menampung air cadangan minimal 6 jam sebelum jadwal tersebut dimulai. Laporan Anda kini kami nyatakan \'Selesai\' di sistem. Sebagai apresiasi atas partisipasi Anda dalam mencari informasi secara tertib, poin tambahan telah ditambahkan ke akun Anda dan dapat diperiksa di menu Reward. Terima kasih.', 0, 0, '2026-05-03 17:32:08'),
(9, 20, 4, 'ok', 0, 0, '2026-05-03 17:36:51');
...
(18, 1, 'Kerusakan Atap dan Bangku Halte Kampus UIN SSC', 'Halo Admin. Saya ingin melaporkan kondisi halte di area kampus UIN Siber Syekh Nurjati Cirebon yang saat ini kondisinya cukup memprihatinkan. Atap halte di sisi kanan sudah mulai bocor saat hujan, dan beberapa baut pada bangku tunggu terlihat lepas/berkarat sehingga membahayakan mahasiswa yang duduk. Mohon segera dilakukan pengecekan melalui fitur Validasi Admin agar kerusakannya tidak semakin parah. Saya harap ada Update Status yang jelas dalam waktu dekat agar kami tahu kapan perbaikan akan dilakukan. Terima kasih.', 'PENGADUAN', '581-Screenshot 2026-05-03 205845.png', '-6.735524, 108.534046', 'selesai', '2026-05-03 14:02:07'),
(19, 1, 'Permohonan Informasi Jadwal Pemeliharaan Jaringan Air Bersih', 'Halo Admin. Saya ingin menanyakan terkait informasi jadwal pemeliharaan rutin jaringan air bersih di wilayah Kecamatan Sumber untuk bulan Mei ini. Mengingat sering terjadi penurunan debit air pada jam-jam tertentu tanpa pemberitahuan sebelumnya, kami sebagai warga memerlukan jadwal resmi agar bisa melakukan antisipasi penampungan air di rumah masing-masing. Mohon kiranya Admin bisa memberikan Balas Laporan yang berisi lampiran jadwal atau tautan informasi yang valid. Saya akan memantau respons ini melalui fitur Cek Status. Terima kasih atas bantuannya.', '', NULL, '-6.758285, 108.471422', 'selesai', '2026-05-03 17:31:15'),
(20, 1, 'p', 'aj', 'ASPIRASI', NULL, '', 'selesai', '2026-05-03 17:36:09');
...
(1, 'Ayes Pahlawan', 'ayes', '123', 'user', 15),
